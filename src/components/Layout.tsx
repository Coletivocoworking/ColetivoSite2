    ...
    <>
      ...
      <AnimatePresence>
        {isLoaderVisible && (
          ...
          >
            <motion.img
              src="http://coletivo.cc/wp-content/uploads/2023/03/Frame-2.png"
              alt="Coletivo"
      ...
      <footer className="bg-black text-white py-32 md:py-48 px-6 md:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          <div className="space-y-8">
            <img src="http://coletivo.cc/wp-content/uploads/2023/03/Frame-2.png" alt="Coletivo" className="w-32 invert brightness-0" />
