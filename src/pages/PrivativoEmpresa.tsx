          ...
          <div className="reveal order-2 lg:order-1 relative">
            <div className="grid grid-cols-2 gap-12">
              <div className="space-y-12 mt-16">
                <img src="http://coletivo.cc/wp-content/uploads/2025/06/2.jpg" className="rounded-3xl shadow-xl" alt="Private Office Detail" />
              ...
              <div className="space-y-12">
                <div className="aspect-[3/4] rounded-[3rem] overflow-hidden shadow-xl border-8 border-grey-50">
                  <img src="http://coletivo.cc/wp-content/uploads/2025/06/4.jpg" className="w-full h-full object-cover" alt="Corporate Service" />
                </div>
                <img src="http://coletivo.cc/wp-content/uploads/2025/06/5.jpg" className="rounded-3xl shadow-xl" alt="Board Room" />
              </div>
            </div>
          </div>
