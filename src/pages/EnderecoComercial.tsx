             ...
             <div className="grid grid-cols-2 gap-8">
              <div className="space-y-12 mt-16">
                <div className="aspect-[4/5] rounded-[3.5rem] overflow-hidden shadow-2xl group border-[12px] border-grey-50">
                  <img src="/images/hero/coletivo-coworking-espacos-hero.jpg" className="w-full h-full object-cover transition-all duration-[2s] ease-out group-hover:scale-105" alt="Unidade Casa 62" />
                </div>
              ...
              <div className="space-y-12">
                ...
                <div className="aspect-[4/5] rounded-[3.5rem] overflow-hidden shadow-2xl group border-[12px] border-grey-50">
                  <img src="/images/hero/coletivo-coworking-sala-privativa-hero.jpg" className="w-full h-full object-cover transition-all duration-[2s] ease-out group-hover:scale-105" alt="Unidade Area 51" />
                </div>
              </div>
            </div>
          </div>
